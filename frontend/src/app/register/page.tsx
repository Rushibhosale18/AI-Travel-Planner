...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#030014] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background Ambience */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-500/20 rounded-full blur-[150px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-400 mt-2">Start planning your dream trips with AI.</p>
        </div>

        <form onSubmit={handleRegister} className="bg-white/[0.03] border border-white/10 p-8 rounded-2xl backdrop-blur-xl shadow-2xl">
          {error && (
          ...
          <div className="mt-8 text-center text-sm text-slate-400">
            ...
            <button type="button" onClick={() => router.push('/login')} className="text-cyan-400 hover:text-cyan-300 font-semibold transition-colors">
              Log in
            </button>
          </div>
        </form>
